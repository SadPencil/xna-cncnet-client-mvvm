...
namespace AvMainClientViewModel.Domain
{
    public class DirectDrawWrapperManager
    {
        ...
        private readonly IGameProcessSettingsService gameProcessSettings;

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor
        public DirectDrawWrapperManager(IGameProcessSettingsService gameProcessSettings)
        {
            this.gameProcessSettings = gameProcessSettings;
...
#pragma warning restore CS8618
        ...
        private void RefreshRenderers()
        {
            ...
            gameProcessSettings.UseQres = selectedRenderer.UseQres;
            gameProcessSettings.SingleCoreAffinity = selectedRenderer.SingleCoreAffinity;
        }
