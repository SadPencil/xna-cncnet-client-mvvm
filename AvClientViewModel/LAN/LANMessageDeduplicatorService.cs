...
/// </summary>
public class LANMessageDeduplicatorService : ILANMessageDeduplicatorService
{
    ...
    /// <summary>
    /// Initializes a new instance of the LANMessageDeduplicatorService class.
    /// </summary>
    ...
    public LANMessageDeduplicatorService(int randomSeed, double messageIdExpirationSeconds = 60.0)
    {
