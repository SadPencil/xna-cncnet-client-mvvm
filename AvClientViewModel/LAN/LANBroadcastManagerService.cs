...
/// </summary>
public class LANBroadcastManagerService : ILANBroadcastManagerService
{
    ...
    /// </summary>
    public event EventHandler<LANBroadcastMessageReceivedEventArgs>? MessageReceived;
    ...
    /// <summary>
    /// Initializes a new instance of the LANBroadcastManagerService class.
    /// </summary>
    ...
    public LANBroadcastManagerService(int lobbyPort, Encoding encoding)
    {
    ...
    public void Initialize()
    {
        lock (socketLock)
        {
            ...
            {
                Log.Error("Creating LAN socket failed! Message: " + ex.ToString());
                throw;
            }
    ...
    private static Dictionary<string, PlayerNetworkInterface> DiscoverBroadcastInterfaces(int port)
    {
        ...
        {
            Log.Warning("Warning: No broadcast interfaces found! LAN lobby broadcasting will not function. " +
    ...
    public bool SendMessage(string message)
    {
        lock (socketLock)
        {
            ...
            {
                Log.Warning("Warning: No broadcast interfaces available in SendMessage!");
            }
    ...
    private void Listen()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Log.Warning("LAN socket listener: exception: " + ex.ToString());
            }
        }
    }
    ...
    {
        MessageReceived?.Invoke(this, new LANBroadcastMessageReceivedEventArgs(data, endPoint));
    }
    ...
    private void RefreshInterfacesPeriodically()
    {
        ...
        {
            Log.Warning("Network interface refresh thread: exception: " + ex.ToString());
        }
    }
    ...
    public void Shutdown()
    {
        ...
        if (listener != null)
        {
            ...
            if (!listenerTerminated)
                Log.Warning("Failed to shut down listener after timeout!");
        ...
        if (interfaceRefresher != null)
        {
            ...
            if (!refresherTerminated)
                Log.Warning("Failed to shut down interface refresher after timeout!");
