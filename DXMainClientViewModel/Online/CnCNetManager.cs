...
namespace DXMainClientViewModel.Online
{
    ...
    public class CnCNetManager : IConnectionManager
    {
        ...
        public CnCNetManager(IUIThreadMarshaller marshaller, GameCollection gc, CnCNetUserData cncNetUserData, Random random)
        {
            gameCollection = gc;
            ...
            cDefaultChatColor = Rgb24Color.FromString(ClientConfiguration.Instance.DefaultChatColor);
            ...
            ircChatColors = new IRCColor[]
            {
                ...
                new IRCColor("Red".L10N("Client:Main:ColorRed"), true, 255, 0, 0, 5),
                new IRCColor("Purple".L10N("Client:Main:ColorPurple"), true, 147, 112, 219, 6),
                new IRCColor("Orange".L10N("Client:Main:ColorOrange"), true, 255, 165, 0, 7),
                new IRCColor("Yellow".L10N("Client:Main:ColorYellow"), true, 255, 255, 0, 8),
                new IRCColor("Lime Green".L10N("Client:Main:ColorLimeGreen"), true, 50, 205, 50, 9),
                new IRCColor("Turquoise".L10N("Client:Main:ColorTurquoise"), true, 64, 224, 208, 10),
                new IRCColor("Sky Blue".L10N("Client:Main:ColorSkyBlue"), true, 135, 206, 235, 11),
                new IRCColor("Blue".L10N("Client:Main:ColorBlue"), true, 65, 105, 225, 12),
                new IRCColor("Pink".L10N("Client:Main:ColorPink"), true, 255, 20, 147, 13),
                new IRCColor("Metallic".L10N("Client:Main:ColorLightGrayMetallic"), true, 211, 211, 211, 14),
                new IRCColor("Gray".L10N("Client:Main:ColorGray"), false, 128, 128, 128, 15)
            };
        }
        ...
        public void OnAttemptedServerChanged(string serverName)
        {
            ...
            marshaller.AddCallback(new Action<string>(DoAttemptedServerChanged), serverName);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoAwayMessageReceived), userName, reason);
        }
        ...
        {
            marshaller.AddCallback(new Action<string>(DoChannelFull), channelName);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoTargetChangeTooFast), channelName, message);
        }
        ...
        {
            marshaller.AddCallback(new Action<string>(DoChannelInviteOnly), channelName);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string, string, List<string>>(DoChannelModesChanged),
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoChannelTopicReceived), channelName, topic);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string, string, string>(DoChatMessageReceived),
        ...
        {
            marshaller.AddCallback(new Action<string, string, string>(DoCTCPParsed),
        ...
        {
            marshaller.AddCallback(new Action(DoConnectAttemptFailed), null);
        }
        ...
        private void DoConnectAttemptFailed()
        {
            ...
            MainChannel.AddMessage(new ChatMessage(Rgb24Color.Red, "Connecting to CnCNet failed!".L10N("Client:Main:ConnectToCncNetFailed")));
        }

        public void OnConnected()
        {
            marshaller.AddCallback(new Action(DoConnected), null);
        }
        ...
        {
            marshaller.AddCallback(new Action<string>(DoConnectionLost), reason);
        }
        ...
        private void DoConnectionLost(string reason)
        {
            ...
            MainChannel.AddMessage(new ChatMessage(Rgb24Color.Red, "Connection to CnCNet has been lost.".L10N("Client:Main:ConnectToCncNetHasLost")));
            connected = false;
        }
        ...
        {
            marshaller.AddCallback(new Action(DoDisconnected), null);
        }
        ...
        {
            MainChannel.AddMessage(new ChatMessage(Rgb24Color.Red, errorMessage));
        }

        public void OnGenericServerMessageReceived(string message)
        {
            marshaller.AddCallback(new Action<string>(DoGenericServerMessageReceived), message);
        }
        ...
        {
            marshaller.AddCallback(new Action<string>(DoIncorrectChannelPassword), channelName);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoPrivateMessageReceived),
                sender, message);
        }
        ...
        {
            marshaller.AddCallback(new Action(DoReconnectAttempt), null);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string, string, string>(DoUserJoinedChannel),
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoUserKicked),
        ...
        {
            marshaller.AddCallback(new Action<string, string>(DoUserLeftChannel),
                channelName, userName);
        }
        ...
        {
            marshaller.AddCallback(new UserListDelegate(DoUserListReceived),
        ...
        {
            marshaller.AddCallback(new Action<string>(DoUserQuitIRC), userName);
        }
        ...
        {
            marshaller.AddCallback(new Action<string>(DoWelcomeMessageReceived), message);
        }
        ...
        {
            marshaller.AddCallback(new Action<string, string, string, string>(DoWhoReplyReceived),
        ...
        {
            marshaller.AddCallback(new Action(DoNameAlreadyInUse), null);
        }
        ...
        private void DoNameAlreadyInUse()
        {
            ...
            else
            {
                ...
                {
                    MainChannel.AddMessage(new ChatMessage(Rgb24Color.White,
        ...
        {
            marshaller.AddCallback(new Action<string>(DoBannedFromChannel), channelName);
        }
        ...
        public void OnUserNicknameChange(string oldNickname, string newNickname)
            => marshaller.AddCallback(new Action<string, string>(DoUserNicknameChange), oldNickname, newNickname);
        ...
        {
            marshaller.AddCallback(new Action<int, int>(DoServerLatencyTested), candidateCount, closerCount);
        }
